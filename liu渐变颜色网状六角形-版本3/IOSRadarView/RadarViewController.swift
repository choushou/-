...
private extension RadarViewController {
    ...
    func initSubviews() {
        ...
        radarView.setDrawAreaColor(color: UIColor.init(red: 8 / 255, green: 7 / 255, blue: 7 / 255, alpha: 0.2))
        
        radarView.setDrawAreaColorThree(color: UIColor.init(red: 1 / 255, green: 108 / 255, blue: 16 / 255, alpha: 1))
        radarView.setDrawAreaColorFour(color: UIColor.init(red: 100 / 255, green: 10 / 255, blue: 1 / 255, alpha: 1))
        radarView.setDrawAreaColorFive(color: UIColor.init(red: 161 / 255, green: 154 / 255, blue: 153 / 255, alpha: 1))
//
//        radarView.setDotColor(color: UIColor.init(red: 143 / 255, green: 143 / 255, blue: 143 / 255, alpha: 1))
        ...
        //白い背景色ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
        
        radarView.setData(data: [RadarModel(title: "Woody", percent: 1), RadarModel(title: "Smoky", percent: 1), RadarModel(title: "Body", percent: 1), RadarModel(title: "Winey", percent: 1), RadarModel(title: "Fruity", percent: 1), RadarModel(title: "Floral", percent: 1)])
        
              radarView.setDataThree(dataThree: [RadarModel(title: "Woody", percent: 0.75), RadarModel(title: "Smoky", percent:0.75), RadarModel(title: "Body", percent: 0.75), RadarModel(title: "Winey", percent: 0.75), RadarModel(title: "Fruity", percent: 0.75), RadarModel(title: "Floral", percent: 0.75)])
        
              radarView.setDataFour(dataFour: [RadarModel(title: "Woody", percent: 0.5), RadarModel(title: "Smoky", percent: 0.5), RadarModel(title: "Body", percent: 0.5), RadarModel(title: "Winey", percent: 0.5), RadarModel(title: "Fruity", percent: 0.5), RadarModel(title: "Floral", percent: 0.5)])
        
              radarView.setDataFive(dataFive: [RadarModel(title: "Woody", percent: 0.25), RadarModel(title: "Smoky", percent: 0.25), RadarModel(title: "Body", percent: 0.25), RadarModel(title: "Winey", percent: 0.25), RadarModel(title: "Fruity", percent: 0.25), RadarModel(title: "Floral", percent: 0.25)])
