...
class HomeCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        self.userName.font = UIFont(name: "Roboto-Regular", size: 12)
        self.creatTime.font = UIFont(name: "Roboto-Regular", size: 12)
        self.readLb.font = UIFont(name: "Roboto-Regular", size: 12)
