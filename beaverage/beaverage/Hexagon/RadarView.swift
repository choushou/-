...
class RadarView: UIView {
   ...
   // private var data: [RadarModel]!
    ...
    private var shapeLayerTest: CAShapeLayer!
    //領域のlayer
...
extension RadarView {
    ...
    func updateLayer() {
        ...
        for ring in 0..<side - 1 {
            ...
            if shapeLayerTest == nil {
                     shapeLayerTest = CAShapeLayer()
                
                     shapeLayerTest.fillColor = UIColor.clear.cgColor
                                shapeLayerTest.strokeColor = UIColor.red.cgColor
                                
                                shapeLayerTest.lineJoin = CAShapeLayerLineJoin.round
                                
                                shapeLayerTest.lineDashPattern = [3,4]
                                shapeLayerTest.path = path
                     shapeLayerTest.frame = CGRect(x: 0, y: 0, width: frame.size.width, height: frame.size.height)
                     layer.insertSublayer(shapeLayerTest, at: 0)
                 } else {
                     shapeLayerTest.path = path
                 }
...
//        }
        ...
        if reginLayerTwo == nil {
            ...
            layer.insertSublayer(reginLayerTwo, above: shapeLayerTest)
...
//        }
        ...
        for node in 0..<side {
            let size = getViewHeight(content: dataTwo[node].title)
            ...
            textLayer.string = dataTwo[node].title //"\(node)\(data[node].title)"
